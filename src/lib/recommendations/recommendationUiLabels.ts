...
export const RECOMMENDATION_SECTION_LABELS = {
  ko: {
    ...
    recommendedHeadingsVideo: '추천 설명란 구성',
    recommendedHeadingsCommerce: '추천 비교/안내 섹션',
  ...
  en: {
    ...
    recommendedHeadingsVideo: 'Suggested description layout',
    recommendedHeadingsCommerce: 'Suggested comparison & policy sections',
